...
def mergeRoadEmiss(outPath,years,IBGE_CODES,roadDensPrefix,typeEmiss):
    print('===================STARTING mergeRoadEmiss_v2.py=======================')
    ...
    names = ['RoadEmiss_BySource_Light_'+typeEmiss+'_','RoadEmiss_BySource_ComLight_'+typeEmiss+'_',
         'RoadEmiss_BySource_Heavy_'+typeEmiss+'_','RoadEmiss_BySource_Motorcycle_'+typeEmiss+'_',
         'HighwaysEmiss_BySource_Light_'+typeEmiss+'_','HighwaysEmiss_BySource_ComLight_'+typeEmiss+'_',
         'HighwaysEmiss_BySource_Heavy_'+typeEmiss+'_','HighwaysEmiss_BySource_Motorcycle_'+typeEmiss+'_',
         'SecondaryEmiss_BySource_Light_'+typeEmiss+'_','SecondaryEmiss_BySource_ComLight_'+typeEmiss+'_',
         'SecondaryEmiss_BySource_Heavy_'+typeEmiss+'_','SecondaryEmiss_BySource_Motorcycle_'+typeEmiss+'_']
    ...
    for name in names:
        ...
        for year in years:
            ...
            brEmiss.to_csv(outPath+'/Merge_'+name+\
